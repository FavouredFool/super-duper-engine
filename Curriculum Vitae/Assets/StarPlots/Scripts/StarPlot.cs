...
public class StarPlot : SerializedMonoBehaviour
{
    [SerializeField][Range(0, 5)] int _starPlotIndex = 0;
    ...
    float[,] _data = new float[,] {
        { 10.3f, 5.3f, 0.2f, 0.9f, 10.3f, 7.7f },
        { 14f, 9.6f, 8.2f, 8.5f, 13.5f, 14f },
        { 86, 86, 84, 76, 60, 65 },
        { 13.0f, 3.4f, 7.1f, 10.0f, 12.1f, 13.0f },
        { 25.6f, 2.4f, 3.0f, 2.8f, 16.9f, 25.6f },
        { 51.9f, 13.0f, 13.0f, 9.1f, 27.8f, 51.9f },
    };

    float[,] _dataNormalized = new float[6, 6];
    ...
    void SetLines()
    {
        Vector3[] polyLinePoints = new Vector3[6];
        Color[] colorPoints = new Color[6];
        ...
        for (int i = 0; i < _lines.Count; i++)
        {
            ...
            Vector3 direction = Vector2.right.Rotate(i * 60f);
